...
def pytest_generate_tests(metafunc):
    ...
    supported = [m for m in pynvest_connect._MODULES if hasattr(m, testfunc)]
...
class TestHistoricalPrices(object):
    ...
    def test_single_date(self, module):
        prices = module.historical_prices('KO', start_date=datetime.date(2012, 3, 12), end_date=datetime.date(2012, 3, 12))
    ...
    def test_multiple_dates_in_reverse_order(self, module):
        prices = module.historical_prices('KO', start_date=datetime.date(2012, 3, 12), end_date=datetime.date(2012, 3, 14))
    ...
    def test_ignore_missing_dates(self, module):
        prices = module.historical_prices('KO', start_date=datetime.date(2012, 3, 9), end_date=datetime.date(2012, 3, 12))
    ...
    def test_funny_symbols(self, module):
        prices = module.historical_prices('BRK.B', start_date=datetime.date(2012, 3, 12), end_date=datetime.date(2012, 3, 12))
...
class TestAdjustedDividends(object):
    ...
    def test_single_dividend(self, module):
        dividends = module.adjusted_dividends('KO', start_date=datetime.date(2012, 3, 13), end_date=datetime.date(2012, 3, 13))

        assert len(dividends) == 1
        assert dividends[0].amount * 100 == 25.5

    def test_multiple_dividends_in_reverse_order(self, module):
        dividends = module.adjusted_dividends('KO', start_date=datetime.date(2012, 3, 13), end_date=datetime.date(2012, 6, 13))
